        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            ...
            <div className="text flex flex-col justify-start items-start">
              ...
              <p className="text-xs">Don Bosco Institute of Technology, Kurla</p>
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.linkedin.com/company/google-developers-student-club-dbit/mycompany/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdsc.dbit/"><div className="cursor-pointer insta">
            ...
            <Link href="https://github.com/GDSC-DBIT"><div className="cursor-pointer insta">
